...
import org.chandler25.elasticsearch.dto.req.SiteDoorPointQueryReq;
 ...
 */
@Slf4j
public class SiteDoorPointQueryConvert implements QueryConvert<SiteDoorPointQueryReq>{
     ...
     * 初始的查询
     */
    private SiteDoorPointQueryReq query;
    /**
     * es查询条件
     */
     ...
     */
    @Override
    public EsQueryDTO convert(SiteDoorPointQueryReq query){
        if(query == null){
            return null;
        }
        this.query = query;
...
//        esQueryDTO.setPageSize(this.query.getPageSize());
     ...
     */
    public SiteDoorPointQueryConvert(Map<String,QueryMapConvert> queryMap,Map<String,List<String>> sortMap){
